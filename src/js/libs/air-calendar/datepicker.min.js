!function (t, e, i) {
    !function () {
        var s, a, n, h = "2.2.3", o = "datepicker", r = ".datepicker-here", c = !1,
            d = '<div class="datepicker"><nav class="datepicker--nav"></nav><div class="datepicker--content"></div><div class="datepicker--actions"><div class="button button_default button_gray">Очистить</div><div class="button button_default">Применить</div></div></div>',
            l = {
                classes: "",
                inline: !1,
                language: "ru",
